...
// };
 ...
 renderSystemMessage(props) {
  ...
  componentDidMount(){
    console.log('gia tri ban dau ',this.state.loading)
    console.log('stateeeeeeeeeeeeeeeeeee')
    console.log(this.state)

    this.listenForItems(this.chatRefData)
    console.log('gia tri spinnerrrrrrrrrrrrrr',this.state.loading)
  }
...
// this.setState({
  ...
  render() {
    console.log('spinner o rende ',this.state.loading)
    return (
      <View style={{ flex: 1 }}>
